...
use aiken_project::{
    ...
    telemetry::{CoverageMode, Terminal},
};
...
impl ReplEvaluator {
    ...
    fn create_temp_project(&self, module_code: &str) -> Result<Project<Terminal>, ReplError> {
...
#[cfg(test)]
mod test {
    use crate::{EvaluationResult, ReplEvaluator, looks_like_expression};
